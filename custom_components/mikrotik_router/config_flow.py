            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(
                        CONF_TRACK_HOSTS,
                        default=self.options.get(CONF_TRACK_HOSTS, DEFAULT_TRACK_HOSTS),
                    ): bool,
                    vol.Optional(
                        CONF_SENSOR_CLIENT_TRAFFIC,
                        default=self.options.get(
                    ...
                    vol.Optional(
                        CONF_SENSOR_NAT,
                        default=self.options.get(CONF_SENSOR_NAT, DEFAULT_SENSOR_NAT),
                    ): bool,
                    vol.Optional(
                        CONF_SENSOR_MANGLE,
                        default=self.options.get(
                    ...
                    vol.Optional(
                        CONF_SENSOR_PPP,
                        default=self.options.get(CONF_SENSOR_PPP, DEFAULT_SENSOR_PPP),
                    ): bool,
                    vol.Optional(
                        CONF_SENSOR_SCRIPTS,
                        default=self.options.get(
