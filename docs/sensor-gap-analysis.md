...
| ~~A5~~ | ~~DHCP lease count~~ | ~~`dhcp-server`~~ | ~~Total active DHCP leases~~ | ~~sensor~~ | ~~Low~~ | **Implemented v2.3.13** — `dhcp_server_lease_count` per server |
...
6. ~~**A5** — DHCP lease count~~ **Implemented v2.3.13**
